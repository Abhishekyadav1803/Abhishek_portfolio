...
import pictureImg from '../assets/Portfolio/abhiiii.png';
...
const Hero = () => {
  ...
  const developerRoles = [
    'FEATURE FILM // COMPUTER SCIENCE STUDENT ',
    'ORIGINAL SERIES // DEEP LEARNING ',
    'BLOCKBUSTER // FULL-STACK ARCHITECT ',
    'ACCLAIMED // ASPIRING SOFTWARE ENGINEER '
  ];
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-between pt-24 pb-12">
        ...
        <div className="hero-anim-item flex items-center justify-between w-full">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            ...
            <span className="text-red-500 font-bold tracking-wider">ABHISHEK YADAV PORTFOLIO</span>
            <span className="text-white/40">|</span>
            <span className="text-white/80">B.TECH  | CGPA 8.14</span>
          </div>
          <div className="hidden md:flex items-center gap-2 text-xs font-mono text-white/50 tracking-wider">
            ...
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">DEEP LEARNING</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3">
              <span className="px-2.5 py-0.5 bg-red-600 text-white font-black text-xs rounded tracking-widest shadow-[0_0_20px_rgba(229,9,20,0.8)] animate-pulse">DEEP LEARNING INTERN</span>
              <span className="text-white/80 text-xs font-mono tracking-widest uppercase">Computer Science Student & AI Enthusiast</span>
            </div>
            ...
            <div className="hero-anim-item flex items-center gap-3 text-xs font-mono text-red-400 font-bold">
              <span className="px-2 py-0.5 bg-red-500/10 border border-red-500/30 rounded text-red-500">Open To Work</span>
              <span className="text-white/40">•</span>
              <span>React • Node.js • MySQL</span>
              <span className="text-white/40">•</span>
              <span className="text-white/70">Python & Cloud</span>
            </div>

            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              Computer Science Engineering student passionate about Artificial Intelligence, Machine Learning and Full Stack Development. Building real-world projects using React, Node.js, Python and Deep Learning.
            </p>
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              ...
              <p className="text-xs text-white/80 leading-relaxed font-light">
                Representative at ICSTIM 2026, Full Stack Web Development & Cybersecurity Specialist, Deep Learning Certified.
              </p>
            </div>
          </div>
