          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Abhishek Yadav</span>, a B.Tech student in Computer Science and Information  at Institute of Engineering and Management, Kolkata.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                My technical narrative bridges rigorous Deep Learning with full-stack software architecture, translating complex backend logic into seamless, high-performance interfaces.
              </p>
            </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>FULL STACK WEB DEVELOPMENT AND CYBERSECURITY <strong className="text-white">LinkedIn Learning</strong> 2023–2024.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                ...
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Certified <strong className="text-white">Deep Learning Specialization</strong> & <strong className="text-white">Database Management</strong>.</span>
                </li>
              </ul>
            </div>
