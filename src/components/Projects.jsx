...
const projectsData = [
  {
    ...
    description: "An Arduino-based working model that would differentiate between wet, dry & metal waste.",
  ...
  },
  {
    ...
    description: "AI-driven scalable full-stack application featuring analytics dashboards, carbon credits, and user engagement mechanisms.",
    tags: ["FastAPI", "PostgreSQL", "Node.js", "Express", "React", "NLP"],
    match: "98%",
    episode: "S01 E02"
  },
  {
    ...
    description: "Face Recognition Attendance System using Raspberry Pi, OpenCV, Flask and MySQL.",
    tags: ["JavaScript", "SQLite", "FastAPI", "NLP", "React"],
    match: "97%",
    episode: "S01 E03"
  },
  {
    title: "Personalized Diet & Health Tracker",
    category: "Full-Stack Web Application",
    description: "AI-driven personalized nutrition and health tracking application with meal planning and progress monitoring.",
    tags: ["JavaScript", "SQLite", "FastAPI", "NLP", "React", "AL & ML"],
    match: "97%",
    episode: "S01 E04"
  },
